...
import LiveTrackMap from '../components/telemetry/LiveTrackMap';

export default function DashboardIndex() {
  // Pull real-time structured telemetry stream data directly from Python BFF
  const { lap, drivers, isLoading, error, resetSession, totalLaps } = useSessionStream();
    ...
    <div className="min-h-screen flex flex-col bg-carbon-900 text-gray-100 font-mono">
      ...
      <header className="border-b border-carbon-600 bg-carbon-800 px-6 py-4 flex justify-between items-center">
        ...
        <button
          ...
          disabled={isLoading}
          className="px-3 py-1.5 bg-red-600 hover:bg-red-700 disabled:bg-gray-700 text-white font-mono text-xs font-bold rounded uppercase tracking-wider transition-colors duration-200"
        >
